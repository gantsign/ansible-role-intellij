      ...
      <roots>
        ...
        <classPath>
          <root type="composite">
            ...
            <root type="simple" url="jrt://{$jdk_home}!/jdk.management.cmm" />
            <root type="simple" url="jrt://{$jdk_home}!/jdk.management.jfr" />
            <root type="simple" url="jrt://{$jdk_home}!/jdk.management.resource" />
