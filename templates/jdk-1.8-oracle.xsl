      ...
      <roots>
        ...
        <classPath>
          <root type="composite">
            ...
            <root type="simple" url="jar://{$jdk_home}/jre/lib/deploy.jar!/" />
            ...
            <root type="simple" url="jar://{$jdk_home}/jre/lib/ext/jfxrt.jar!/" />
            ...
            <root type="simple" url="jar://{$jdk_home}/jre/lib/javaws.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/jce.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/jfr.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/jfxswt.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/jsse.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/management-agent.jar!/" />
            <root type="simple" url="jar://{$jdk_home}/jre/lib/plugin.jar!/" />
        ...
        <sourcePath>
          <root type="composite">
            ...
            <root type="simple" url="jar://{$jdk_home}/javafx-src.zip!/" />
          </root>
        </sourcePath>
      </roots>
      <additional />
